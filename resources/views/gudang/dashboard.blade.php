    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-5">
            @foreach([
                ...
                ['label' => 'Menunggu penerimaan', 'value' => number_format($pendingReceiving, 0, ',', '.'), 'meta' => 'PO siap diterima'],
            ] as $metric)
        ...
        <section class="rounded-2xl border border-black/[0.06] bg-white p-5 dark:border-white/[0.08] dark:bg-white/[0.04]">
            <div>
                <h2 class="text-sm font-semibold text-[#171719] dark:text-white">Akses gudang</h2>
                <p class="mt-1 text-xs text-black/40 dark:text-white/40">Jalur kerja utama untuk penerimaan, opname, dan monitoring stok.</p>
            </div>
            <div class="mt-4 grid gap-2 sm:grid-cols-2 lg:grid-cols-4">
                <a href="{{ route('gudang.penerimaan.index') }}" class="rounded-xl border border-black/[0.06] bg-white px-4 py-3 text-xs font-semibold text-gray-800 transition hover:border-[#A8F23A] hover:bg-[#A8F23A]/10 dark:border-white/[0.08] dark:bg-white/[0.04] dark:text-white">Penerimaan Barang</a>
                <a href="{{ route('gudang.stock-opname.index') }}" class="rounded-xl border border-black/[0.06] bg-white px-4 py-3 text-xs font-semibold text-gray-800 transition hover:border-[#A8F23A] hover:bg-[#A8F23A]/10 dark:border-white/[0.08] dark:bg-white/[0.04] dark:text-white">Stock Opname</a>
                <a href="{{ route('gudang.barang-keluar.index') }}" class="rounded-xl bg-[#A8F23A] px-4 py-3 text-center text-xs font-semibold text-gray-900 transition hover:opacity-85">Barang Keluar</a>
                <a href="{{ route('gudang.riwayat-stok.index') }}" class="rounded-xl border border-black/[0.06] bg-white px-4 py-3 text-xs font-semibold text-gray-800 transition hover:border-[#A8F23A] hover:bg-[#A8F23A]/10 dark:border-white/[0.08] dark:bg-white/[0.04] dark:text-white">Riwayat Stok</a>
            </div>
        </section>
