<x-app-layout>
    <div class="h-full flex flex-col gap-5">
        <div>
            ...
            <h2 class="mt-1 text-2xl font-semibold text-[#171719] dark:text-white">Pesanan</h2>
        </div>
        ...
        <div class="flex-1 rounded-2xl border border-black/5 dark:border-white/10 bg-white dark:bg-white/5 overflow-hidden">
            <div class="px-5 py-4 border-b border-black/5 dark:border-white/10">
                <h3 class="text-sm font-semibold text-[#171719] dark:text-white">Data Pesanan</h3>
            </div>
            <div class="h-full flex items-center justify-center px-5 pb-16">
                <div class="text-center">
                    ...
                    <p class="mt-1 text-xs text-black/40 dark:text-white/40">Data pesanan akan tampil di halaman ini.</p>
                </div>
            </div>
        </div>
    </div>
