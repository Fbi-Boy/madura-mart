<x-app-layout>
    ...
    <div
        ...
        class="min-h-max flex flex-col pb-6"
    >
        ...
        <div class="h-[128px] shrink-0 grid grid-cols-5 gap-2.5">
            ...
            <div class="min-w-0 rounded-[13px] bg-[#171719] text-white dark:bg-white dark:text-[#171719] p-3 flex flex-col justify-between">
                <div>
                    <span class="inline-flex rounded-full bg-white/10 dark:bg-black/[0.06] px-2 py-0.5 text-[7px] font-semibold text-white/60 dark:text-black/50">Monitoring</span>
                    <h3 class="mt-2 text-[15px] font-semibold tracking-[-0.03em]">Penjualan</h3>
                    <p class="mt-1 text-[7px] leading-[1.45] text-white/45 dark:text-black/45">Pantau transaksi, omzet, kasir, dan kondisi penjualan mart.</p>
                </div>
                <button type="button" class="h-7 w-full rounded-[8px] bg-[#A8F23A] text-[8px] font-semibold text-[#171719]">Buat Laporan</button>
            </div>

        </div>

        {{-- BOTTOM --}}
        <div class="mt-2.5 min-h-[520px] grid grid-cols-[minmax(0,1fr)_280px] gap-2.5">

            {{-- TABLE --}}
            <div class="min-w-0 rounded-[13px] border border-black/[0.055] dark:border-white/[0.08] bg-white dark:bg-white/[0.04] overflow-hidden flex flex-col">
                ...
                <div class="h-[43px] shrink-0 flex items-center justify-between border-b border-black/[0.05] dark:border-white/[0.07] px-3">
                    ...
                    <span class="rounded-full bg-black/[0.04] dark:bg-white/[0.07] px-2 py-1 text-[7px] text-black/40 dark:text-white/40">312 transaksi</span>
                </div>
            ...
            {{-- RIGHT --}}
            <div class="min-h-[520px] flex flex-col gap-2.5">

                {{-- STRUK --}}
                <div class="min-h-[400px] rounded-[13px] border border-black/[0.055] dark:border-white/[0.08] bg-white dark:bg-white/[0.04] overflow-hidden">
                    ...
                    <div class="p-3">
                        ...
                        <div class="py-2.5 space-y-1.5">
                            <div class="flex justify-between gap-2"><span class="truncate text-[7px] text-black/45 dark:text-white/45">Sembako Full Cream 1L</span><span class="text-[7px] font-medium text-[#171719] dark:text-white">Rp 38.000</span></div>
                            <div class="flex justify-between gap-2"><span class="truncate text-[7px] text-black/45 dark:text-white/45">Roti Gandum Toast</span><span class="text-[7px] font-medium text-[#171719] dark:text-white">Rp 28.000</span></div>
                            <div class="flex justify-between gap-2"><span class="truncate text-[7px] text-black/45 dark:text-white/45">Beras Premium Pandan</span><span class="text-[7px] font-medium text-[#171719] dark:text-white">Rp 85.000</span></div>
                            <div class="flex justify-between gap-2"><span class="truncate text-[7px] text-black/45 dark:text-white/45">Minyak Goreng</span><span class="text-[7px] font-medium text-[#171719] dark:text-white">Rp 37.000</span></div>
                        </div>

                        <div class="border-t border-dashed border-black/10 dark:border-white/10 pt-2">
                            <div class="flex justify-between"><span class="text-[7px] text-black/40 dark:text-white/40">Subtotal</span><span class="text-[7px] font-medium text-[#171719] dark:text-white">Rp 195.000</span></div>
                            <div class="mt-1 flex justify-between"><span class="text-[7px] text-black/40 dark:text-white/40">Diskon Member</span><span class="text-[7px] font-medium text-[#171719] dark:text-white">- Rp 9.750</span></div>
                        ...
                        <button type="button" class="mt-2.5 w-full h-7 rounded-[8px] bg-[#A8F23A] text-[8px] font-semibold text-[#171719]">✓ Verifikasi Struk</button>

                        <div class="mt-1.5 grid grid-cols-2 gap-1.5">
                            <button type="button" class="h-6 rounded-[7px] bg-[#FFF0F0] text-[7px] font-semibold text-[#A52A2A] dark:bg-[#FF5757]/10 dark:text-[#FF8585]">Tandai Anomali</button>
                            <button type="button" class="h-6 rounded-[7px] bg-black/[0.04] text-[7px] font-semibold text-black/50 dark:bg-white/[0.07] dark:text-white/50">Log Audit</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="h-[96px] shrink-0 rounded-[13px] border border-[#F1D7D7] dark:border-[#FF5757]/20 bg-[#FFF9F9] dark:bg-[#FF5757]/[0.06] p-3">
                    <div class="flex items-start gap-2">
                        ...
                        <div class="min-w-0">
                            <h4 class="text-[9px] font-semibold text-[#8A2020] dark:text-[#FF8585]">Laporkan Anomali Transaksi</h4>
                            <p class="mt-0.5 text-[7px] leading-[1.45] text-[#9B6A6A] dark:text-white/40">Temukan transaksi yang tidak wajar? Laporkan untuk ditinjau supervisor.</p>
                        </div>
                    </div>
                    <button type="button" class="mt-2 w-full h-6 rounded-[7px] border border-[#E7BEBE] dark:border-[#FF5757]/20 text-[7px] font-semibold text-[#8A2020] dark:text-[#FF8585]">Laporkan Transaksi Terpilih</button>
                </div>
